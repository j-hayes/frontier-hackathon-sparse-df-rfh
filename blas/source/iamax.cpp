...
void run_iamax_example(const sycl::device &dev) {
    ...
    sycl::buffer<int64_t, 1> result_buffer(&result, 1);
    ...
    auto result_accessor = result_buffer.template get_access<sycl::access::mode::read>();
